export enum LQCollideInfoList {
    default, role, role_bullet, enemy, enemy_bullet, prop, prop_receiver, shield
}
...
export class LQCollideConfig {
    ...
    public static active_area_width: number = 740;
    public static active_area_height: number = 1300;
    public static collide_group_map = {
        "default": {id: 1, category: 1, index: 0, mask: 0},
        "role": {id: 2, category: 2, index: 1, mask: 24},
        "role_bullet": {id: 3, category: 4, index: 2, mask: 8},
        "enemy": {id: 4, category: 8, index: 3, mask: 6},
        "enemy_bullet": {id: 5, category: 16, index: 4, mask: 130},
        "prop": {id: 6, category: 32, index: 5, mask: 64},
        "prop_receiver": {id: 7, category: 64, index: 6, mask: 32},
        "shield": {id: 8, category: 128, index: 7, mask: 16},
    }
}
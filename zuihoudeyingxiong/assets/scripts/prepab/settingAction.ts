...
import { emits as legacyEmits, localData } from '../../script/data/enums';
import { getScopedPlayerListKey, getScopedSelectTypeKey, save } from '../../script/utils/tools';
...
export class setting extends Component {
    ...
    backBtn2() {
        ...
        localStorage.removeItem(localData.playerList);
        localStorage.removeItem(localData.slectType);
        localStorage.removeItem(getScopedPlayerListKey());
        localStorage.removeItem(getScopedSelectTypeKey());

...
export class gameConfig {
    static readonly defaultPlayerList = [[{ type: 1, isJiesuo: 1, price: 0 }, { type: 2, isJiesuo: 0, price: 1000 }, { type: 3, isJiesuo: 0, price: 3000 }], [{ type: 4, isJiesuo: 0, price: 5000 }, { type: 5, isJiesuo: 0, price: 8000 }]]
    static APP_ID = 'yongshigame003'
    // 是否开启微信广告
    static isWxAd = false
    // 是否复活
    static ifFuhuo = 0
    ...
    static playerList = JSON.parse(JSON.stringify(gameConfig.defaultPlayerList))
    // 当前页码
    static page = 0
    // 当前选择角色
    static slectType = 1

...
export default class UserDataSyncManager {
    ...
    public static isNewbieGuideCompleted(): boolean {
        return cc.sys.localStorage.getItem(
            this.getScopedKey(this.NEWBIE_GUIDE_COMPLETED_KEY)
        ) === "true";
    }

    public static markNewbieGuideCompleted(): void {
        if (this.isNewbieGuideCompleted()) {
            return;
        }
    ...
    private static buildLocalPayload(): RemoteUserDataPayload {
        ...
        return {
            ...
            newbieGuideCompleted: this.isNewbieGuideCompleted()
        };
    }
    ...
    private static applyPayloadToLocal(payload: RemoteUserDataPayload): void {
        ...
        if (payload.newbieGuideCompleted === true) {
            cc.sys.localStorage.setItem(
                this.getScopedKey(this.NEWBIE_GUIDE_COMPLETED_KEY),
                "true"
            );

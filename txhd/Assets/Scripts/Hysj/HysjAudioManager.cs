...
namespace Hysj
{
    /// <summary>Owns the single looping BGM source shared by the main and gameplay scenes.</summary>
    public sealed class HysjAudioManager : MonoBehaviour
    {
        private const string MainMusicPath = "HysjLegacy/sound/bgm_02";
        private const string GameplayMusicPath = "HysjLegacy/sound/bgm_12";
        ...
        {
            EnsureLoaded();
            instance.PlayClip(GameplayMusicPath, true);
        }
